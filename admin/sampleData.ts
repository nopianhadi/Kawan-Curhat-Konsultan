// Sample data untuk demo admin panel
// Data ini bisa digunakan untuk populate content manager
...
export const sampleTestimonials = [
  {
    ...
    content: 'Konsultasi yang sangat membantu! Kawan Curhat Konsultan memberikan solusi praktis untuk masalah kontrak bisnis kami. Sangat profesional dan mudah dipahami.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Pendekatan yang komunikatif dan solutif membuat kami merasa nyaman. Kawan Curhat Konsultan benar-benar mitra bisnis yang terpercaya.',
    rating: 5,
    image: '/aset/HCPDxtAQXS7vgrwsd6svNhxA.png'
  }
];
...
export const sampleFAQs = [
  {
    id: '1',
    question: 'Apa saja layanan yang ditawarkan Kawan Curhat Konsultan?',
  ...
  {
    id: '2',
    question: 'Bagaimana cara memulai konsultasi dengan Kawan Curhat Konsultan?',
...
export const sampleGallery = [
  {
    id: '1',
    title: 'Kantor Pusat',
    description: 'Kantor pusat Kawan Curhat Konsultan',
...
// Helper function untuk load sample data
export const loadSampleData = (contentType: string) => {
  switch (contentType) {
    case 'blog':
    ...
    case 'videos':
      return sampleVideoTestimonials;
    case 'faq':
      return sampleFAQs;
    case 'gallery':
