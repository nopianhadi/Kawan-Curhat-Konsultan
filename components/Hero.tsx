...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-brand-dark/80 via-brand-dark/70 to-brand-dark/80"></div>
      
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-72 h-72 bg-brand-accent/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-brand-accent/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center text-white py-20 sm:py-32 md:py-40 lg:py-48">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 justify-center items-center animate-slideUp" style={{ animationDelay: '0.4s' }}>
          <a 
            href="#contact" 
            className="inline-block bg-brand-accent text-white font-semibold px-5 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 text-xs sm:text-sm md:text-base rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-brand-accent/50 btn-ripple"
          >
            Hubungi Kami
          </a>
          <a 
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 lg:gap-8 max-w-3xl mx-auto mt-6 sm:mt-10 md:mt-12 lg:mt-16 animate-fadeIn" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="text-center border-x border-white/20">
            <div className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-brand-accent mb-0.5 sm:mb-1 md:mb-2">500+</div>
          ...
          <div className="text-center">
            <div className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-brand-accent mb-0.5 sm:mb-1 md:mb-2">1000+</div>
