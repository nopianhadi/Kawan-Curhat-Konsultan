...
const BlogDetail: React.FC<BlogDetailProps> = ({ postId = '10-pertanyaan-kunci', onClose }) => {
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-brand-accent text-white rounded-xl shadow-lg p-4 sm:p-6">
              ...
              <button className="w-full bg-white text-brand-accent font-semibold py-2.5 sm:py-3 rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base">
                Hubungi Kami
              </button>
            </div>
          </div>
